...
<div class="modal fade" id="educatorUpdatePwdSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <div>
...
<!-- Modal for successful updation of Password -->
<div class="modal fade" id="educatorUpdateInfoSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <div>
...
<script>
		$(document).ready(function(){
			    $("#educatorUpdatePwdSuccess").modal("show");
...
<script>
		$(document).ready(function(){
			    $("#educatorUpdateInfoSuccess").modal("show");
	...
	<div class="container admin_profile">
        <div class="row">
            ...
            <div class="col-md-2" style="color:#44b3fd">
                <a href="editEducatorProfile.jsp">Edit Profile
...
<form class="needs-validation" action="UpdateEducatorProfileEmail" method="post" novalidate>
...
<form class="needs-validation" action="ChangeEducatorPwd" method="post" novalidate>
