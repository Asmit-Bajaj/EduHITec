...
@WebServlet(urlPatterns= {"/CheckAdminPwd"})
public class CheckAdminPwd extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			ps.setInt(1, (Integer)req.getSession(false).getAttribute("admin_id"));
			...
			System.out.println("exception at CheckAdminPwd : "+e);
		}
	}
}
