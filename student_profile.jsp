...
<div class="modal fade" id="studentUpdatePwdSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <div>
...
<!-- Modal for successful updation of Password -->
<div class="modal fade" id="studentUpdateInfoSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <div>
...
<script>
		$(document).ready(function(){
			    $("#studentUpdatePwdSuccess").modal("show");
...
<script>
		$(document).ready(function(){
			    $("#studentUpdateInfoSuccess").modal("show");
	...
	<div class="container admin_profile">
        <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="admin_profile_details tab-content">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p style="font-weight: 700;">Roll No.</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><%=bean.getRoll_no()%></p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p style="font-weight: 700;">Class.</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><%=bean.getStd_class()%></p>
                                    </div>
                                </div>
                                <%
                                	}else{
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p style="font-weight: 700;">Section.</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><%=bean.getSection()%></p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p style="font-weight: 700;">Branch.</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><%=bean.getBranch()%></p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p style="font-weight: 700;">Degree.</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><%=bean.getDegree()%></p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p style="font-weight: 700;">Batch.</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><%=bean.getBatch()%></p>
                                    </div>
            ...
            <div class="col-md-2" style="color:#44b3fd">
                <a href="editStudentProfile.jsp">Edit Profile
...
<form class="needs-validation" action="UpdateStudentProfileEmail" method="post" novalidate>
...
<form class="needs-validation" action="ChangeStudentPwd" method="post" novalidate>
