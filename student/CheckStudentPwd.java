...
@WebServlet(urlPatterns = {"/CheckStudentPwd"})
public class CheckStudentPwd extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			ps.setInt(1, (Integer)req.getSession(false).getAttribute("std_id"));
			...
			System.out.println("exception at CheckStudentPwd : "+e);
		}
	}
}
