...
<title>EduHITec | Add Educator</title>
<link href="css/style.css" rel="stylesheet">
</head>
<body>

<!-- Modal for successful addition of Educator -->
<div class="modal fade" id="educatorAddSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <div>
        	Educator added Successfully !!! <br><br>A Validation link is sent on the email address specified <br>Please
...
<div class="modal fade" id="educatorAddError" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <div>
...
<%@include file="admin_menu.html"%>
 <h4 style="margin:3%;" align="center">Fill Up The Following Details of Educator :- <hr></h4>
...
<%
	if(session.getAttribute("no_validEdu") != null){
		EducatorBean bean = (EducatorBean)session.getAttribute("no_validEdu");
...
%>
    ...
    <form class="was-validated" novalidate action="AddEducator" method="post">
        <div class="form-row">
...
<div class="educator-form-box">
    ...
    <form class="needs-validation" novalidate action="AddEducator" method="post">
        <div class="form-row">
            <div class="form-group col-md-3">
              <label for="firstname">First Name <span style="color:red;">*</span></label>
              <input type="text" class="form-control" id="firstname" placeholder="First Name ..." name="firstname"
